...
export const JBCoiffure: BarberConfig = {
  domain: "jb-coiffure",
  name: "JB Coiffure",
  legalName: "JB Coiffure",
  title: "Votre Barber Coiffeur à Poitiers",
  subTitle: "Votre style. Notre signature",
  logo: "/images/logo-generic.png",
  slogan: "COUPES PRECISES. ATTITUDE LIBRE.",
  description:
    "Barber et Coiffeur à Poitiers. Dégradés nets, tailles de barbe, structures et direction stylistique urbaine pour ceux qui veulent plus qu'une coupe.",
  city: "Poitiers",
  address: "135 Av. Gambetta, 16006 Angoulême",
  phone: "05 45 95 54 13",
  email: "contact@jbcoiffure.fr",
  instagram: "jb.coiffure",
  bookingUrl: "https://www.planity.com/jb-coiffure-16006-angouleme",
