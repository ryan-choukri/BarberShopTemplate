...
export const FloStudioBarber: BarberConfig = {
  domain: "flo-studio-barber",
  name: "Flo Studio Barber",
  legalName: "Flo Studio Barber",
  title: "Votre Barber à Poitiers",
  subTitle: "Votre style. Notre signature",
  logo: "/images/logo-generic.png",
  slogan: "COUPES PRECISES. ATTITUDE LIBRE.",
  description:
    "Barber studio à Poitiers. Dégradés nets, tailles de barbe, structures et direction stylistique urbaine pour ceux qui veulent plus qu'une coupe.",
  city: "Poitiers",
  address: "54 Rte de Gençay, 86000 Poitiers",
  phone: "06 66 19 66 05",
  email: "contact@flostudiobarber.fr",
  instagram: "flostudiobarber",
  bookingUrl: "https://www.planity.com/flo-studio-barber-86000-poitiers",
