...
export const MammeriCoiffure: BarberConfig = {
  domain: "mammeri-coiffure",
  name: "Mammeri Coiffure",
  legalName: "Mammeri Coiffure",
  title: "Votre Coiffeur à Poitiers",
  subTitle: "Votre style. Notre signature",
  logo: "/images/logo-generic.png",
  slogan: "COUPES PRECISES. ATTITUDE LIBRE.",
  description:
    "Coiffeur à Poitiers. Dégradés nets, tailles de barbe, structures et direction stylistique urbaine pour ceux qui veulent plus qu'une coupe.",
  city: "Poitiers",
  address: "85 Bd du Grand Cerf, 86000 Poitiers",
  phone: "06 10 94 16 00",
  email: "contact@mammeri-coiffure.fr",
  instagram: "mammeri.coiffure",
  bookingUrl: "https://www.planity.com/mammeri-coiffure-86000-poitiers",
