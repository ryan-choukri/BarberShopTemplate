...
export const BarberKluHouse: BarberConfig = {
  domain: "klu-house",
  name: "K'lu House",
  legalName: "K'lu House",
  ...
  city: "Poitiers",
  address: "28 Rue Carnot, 86000 Poitiers",
  phone: " 06 95 91 15 83",
  email: "contact@klubarber.fr",
  instagram: "kluhouse",
  bookingUrl: "https://www.planity.com/klu-house-86000-poitiers",
