...
export const BestBarberCoiffureConfig: BarberConfig = {
  domain: "best-barber-coiffure",
  ...
  city: "Montpellier",
  address: "4 Rue de Substantion, 34000 Montpellier",
  phone: "07 51 52 43 40",
  email: "",
  instagram: "@bestbarber34",
  instagramUrl: "https://www.instagram.com/bestbarber34/",
  bookingUrl: "",
  mapsUrl: "https://maps.app.goo.gl/5YKdEXdKaf3QQv5f7",
  accentColor: "#5f3914",
  openingHours: [
